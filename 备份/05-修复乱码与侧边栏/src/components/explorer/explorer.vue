...
function getFileIcon(file) {
  ...
  if (file.type === "WebDir") {
    if (file.system) {
      return '<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="4" y="14" width="40" height="24" rx="3" fill="none" stroke="#0078d4" stroke-width="4"/><circle cx="14" cy="26" r="3" fill="#0078d4"/><circle cx="36" cy="26" r="2" fill="#0078d4"/><path d="M8 20H40" stroke="#0078d4" stroke-width="2"/></svg>'
    }
        ...
        <div v-for="group in sidebarItems" :key="group.key" class="sidebar-group">
          ...
          <div v-show="sidebarExpanded[group.key]" class="sidebar-children">
            <div v-for="child in group.children" :key="child.path"
              ...
              <span class="sidebar-item-icon" v-html="child.path.match(/^\/[A-Z]$/) ? '<svg viewBox=\'0 0 48 48\' fill=\'none\' xmlns=\'http://www.w3.org/2000/svg\' width=\'16\' height=\'16\'><rect x=\'4\' y=\'14\' width=\'40\' height=\'24\' rx=\'3\' fill=\'none\' stroke=\'#0078d4\' stroke-width=\'4\'/><circle cx=\'14\' cy=\'26\' r=\'3\' fill=\'#0078d4\'/><circle cx=\'36\' cy=\'26\' r=\'2\' fill=\'#0078d4\'/><path d=\'M8 20H40\' stroke=\'#0078d4\' stroke-width=\'2\'/></svg>' : '&#128193;'"></span>
...
.file-item.icons {
  display: flex; flex-direction: column; align-items: center;
  width: 90px; padding: 8px 6px; cursor: default;
  border: 1px solid transparent; border-radius: 3px;
}
.file-item.icons:hover { background: #e8f0fe; }
.file-item.icons.selected { background: #c0e0ff; border-color: #0078d4; }
.file-item.icons .file-icon { width: 48px; height: 48px; margin-bottom: 6px; flex-shrink: 0; }
.file-item.icons .file-icon svg { width: 48px; height: 48px; display: block; }
