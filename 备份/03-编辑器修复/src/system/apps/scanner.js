...
export async function scanAndRegisterApps() {
  ...
  if (!getApp('textviewer')) {
    const comp = (await import('@/apps/textviewer/index.vue')).default
    registerApp('textviewer', {
      hasWindow: true,
      name: '文本查看器',
      icon: '<svg width="24" height="24" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 6C8 4.89543 8.89543 4 10 4H30L40 14V42C40 43.1046 39.1046 44 38 44H10C8.89543 44 8 43.1046 8 42V6Z" fill="none" stroke="#0078d4" stroke-width="4" stroke-linejoin="round"/><path d="M16 18H32" stroke="#0078d4" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M16 25H32" stroke="#0078d4" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M16 32H28" stroke="#0078d4" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/><path d="M30 4V14H40" stroke="#0078d4" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
      component: comp,
      extensions: ['txt', 'md', 'js', 'html', 'css', 'json', 'xml', 'ini', 'cfg', 'log', 'bat', 'sh', 'py', 'java', 'c', 'cpp', 'h', 'yml', 'yaml', 'toml', 'csv', 'ts', 'jsx', 'tsx', 'vue', 'php', 'rb', 'go', 'rs', 'swift', 'kt'],
      windowWidth: 70,
      windowHeight: 80,
      minWidth: 350,
      minHeight: 250,
      menu: [
        { title: '打开', hander: () => launchApp('textviewer', { title: '文本查看器' }) },
      ]
    })
  }
  if (!getApp('notepad')) {
