...
const menuData=[
	...
	},
	{
		...
		hander:()=>{
			const pwd = "/C/Desktop"; const name = "新建文本文档.txt"; let file = new WebFile(pwd, name); file.write(""); file.save(); fileList[config.desktop.path].push(file); editFile.value = file; editFileName = file.name; initAppList()
		}
	},
	{
		title:"新建文件夹",
